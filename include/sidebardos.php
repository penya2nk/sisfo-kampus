...
<a href="/home" class="brand-link navbar-light">
      <img src="asset/logo/logo_stmik.png" alt="Admin Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light" style='color:#000'><b style='color:#ff5113;font-family:Tahoma'>PANEL DOSEN </b></span>
    </a>
      ...
      <nav class="mt-2">
        ...
        <li class="nav-header">MAIN MENU</li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class='nav-item'><a class='nav-link' href="?ndelox=lecturer/penasehat_ak&mdlid=38&prodi=<?php echo"$_SESSION[aksess]";?>&tahun=<?php echo"$_SESSION[tahun_akademik]";?>&<?php echo"$_snm";?>=<?php echo"$_sid";?>"><i class='far fa-circle nav-icon text-success'></i> <p>Penasehat Akademik</p></a></li>
              <li class='nav-item'><a class='nav-link' href="?ndelox=lecturer/schedule_lect&mdlid=38&prodi=<?php echo"$_SESSION[aksess]";?>&tahun=<?php echo"$_SESSION[tahun_akademik]";?>&<?php echo"$_snm";?>=<?php echo"$_sid";?>"><i class='far fa-circle nav-icon text-success'></i> <p>Jadwal Kuliah</p></a></li>
              <li class='nav-item'><a class='nav-link' href="?ndelox=dep/absensi&mdlid=155&prodi=<?php echo"$_SESSION[aksess]";?>&tahun=<?php echo"$_SESSION[tahun_akademik]";?>&<?php echo"$_snm";?>=<?php echo"$_sid";?>"><i class='far fa-circle nav-icon text-success'></i> <p>Absensi</p></a></li>
              <li class='nav-item'><a class='nav-link' href="?ndelox=dep/penilaian&mdlid=38&prodi=<?php echo"$_SESSION[aksess]";?>&tahun=<?php echo"$_SESSION[tahun_akademik]";?>&<?php echo"$_snm";?>=<?php echo"$_sid";?>"><i class='far fa-circle nav-icon text-success'></i> <p>Nilai</p></a></li>
