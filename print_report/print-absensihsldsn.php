...
$mboh     = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM vw_mengajar where JadwalID='".strfilter($_GET[JadwalID])."' and DosenID='$_SESSION[_Login]'"));
...
$sq = mysqli_query($koneksi, "SELECT krs.*, jadwal.Kehadiran,
	...
	AND jadwal.DosenID='$_SESSION[_Login]'
