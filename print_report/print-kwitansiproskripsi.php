...
//penguji 1 ----------------------------------------------------------------------------------------------------
$dtu1 = mysqli_fetch_array(mysqli_query($koneksi, "select Login,Nama,Gelar from dosen where Login='$dta[PengujiPro1]'"));	
$Namac 		= strtolower($dtu1['Nama']);
$Penguji1	= ucwords($Namac);

//penguji 2 ----------------------------------------------------------------------------------------------------
$dtu2 = mysqli_fetch_array(mysqli_query($koneksi, "select Login,Nama,Gelar from dosen where Login='$dta[PengujiPro2]'"));	
$Namad 		= strtolower($dtu2['Nama']);
$Penguji2	= ucwords($Namad);

//penguji 3 ----------------------------------------------------------------------------------------------------
$dtu3 = mysqli_fetch_array(mysqli_query($koneksi, "select Login,Nama,Gelar from dosen where Login='$dta[PengujiPro3]'"));	
...
$dth = mysqli_fetch_array(mysqli_query($koneksi, "select * from t_biaya where BiayaID='3'"));	//pro skripsi										 
$n1 =$dth['Jumlah'];
...
<td >:</td>
<td style=font-style:italic>&nbsp;<textarea cols=49 rows=2 >$Nominal rupiah</textarea></td>
</tr>

<tr class='batas2' align='left'>
<td >&nbsp;Untuk pembayaran</td>
<td >:</td>
<td >&nbsp;Honor Penguji Ujian Proposal Skripsi Tahun $dta[TahunID]</td>
</tr>
...
<td >&nbsp;Untuk pembayaran</td>
<td >:</td>
<td >&nbsp;Honor Penguji Ujian Proposal Skripsi $dta[TahunID]</td>
</tr>
