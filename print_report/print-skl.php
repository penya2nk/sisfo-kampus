...
$dt        		= mysqli_fetch_array(mysqli_query($koneksi, "select t_suratadm.*,mhsw.Nama,mhsw.Alamat,mhsw.TempatLahir,mhsw.TanggalLahir 
                        ...
                        and t_suratadm.MhswID='".strfilter($_GET[MhswID])."' 
                        and t_suratadm.TahunID='$_SESSION[tahun_akademik]'"));
...
<html>
  ...
  <body onload="window.print();">
    ...
    <br>
      ...
      <tr>
      <td width="130" colspan="4" style="text-align:justify">Dengan hormat, <br>Ketua Program Studi <?php echo $prodi[Nama] ?> Universitas Teknokrat Indonesia, dengan ini menerangkan bahwa:<br> <br></td>
      </tr>



      <tr>
      <td width="130" colspan="4" style="text-align:justify">Dengan ini menerangkan bahwa:<br></td>
      </tr>
