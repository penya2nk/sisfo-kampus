...
$dos   			= mysqli_fetch_array(mysqli_query($koneksi, "SELECT Login,Nama,Gelar,NIDN FROM dosen where Login='$dt[PembimbingSkripsi2]'"));
$namarien 		= $dos['Nama'];
...
<table width='800'  >
  ...
  <tr>
    <td width='81'>&nbsp;</td>
    <td width='10'>&nbsp;</td>
    <td colspan='3'>Yth. $pembimbing2, $dos[Gelar] </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
