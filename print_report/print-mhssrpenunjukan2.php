...
$dos   			= mysqli_fetch_array(mysqli_query($koneksi, "SELECT Login,Nama,Gelar,NIDN FROM dosen where Login='$dt[Pembimbing2]'"));
$nama_kecild 	= strtolower($dos[Nama]);
$pembimbing2	= ucwords($nama_kecild);	
...
<table width='800'  >
  ...
  <tr>
    <td width='81'>&nbsp;</td>
    <td width='10'>&nbsp;</td>
    <td colspan='3'>Yth. Bapak/Ibu $pembimbing2, $dos[Gelar] </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan='3'>Dosen Pembimbing II  (Pembimbing Pendamping) Skripsi</td>
  </tr>
  <tr>
    <td width='81'>&nbsp;</td>
    <td width='10'>&nbsp;</td>
