...
$mhs       = mysqli_fetch_array(mysqli_query($koneksi, "SELECT ProdiID,ProgramID,MhswID,Nama FROM mhsw where MhswID='$_SESSION[_Login]'"));
...
$ss       = mysqli_fetch_array(mysqli_query($koneksi, "SELECT KHSID,Sesi,TahunID,MhswID FROM khs where MhswID='$_SESSION[_Login]' and TahunID='".strfilter($_GET['tahun'])."'"));
if ($ProdiID=='SI'){
...
$sq = mysqli_query($koneksi, "SELECT * from vw_krs where MhswID='$_SESSION[_Login]' and TahunID='".strfilter($_GET['tahun'])."'");
