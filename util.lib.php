...
<div class="box-body">
<?php 
echo"<input class='btn btn-success btn-sm' type=button name='TambahRuangan' value='Tambah Ruangan' onClick=\"location='?ndelox=ruang&act=editdata&md=1'\" />";
?>
        ...
        <table id="example" class="table table-bordered table-striped">
          <thead>
            <tr style=text-align:left;font-size:14px;color:#FFFFFF;font-weight:reguler;background-color:#3c8dbc;>
              ...
              <th style='width:120px'>Nama Ruangan</th>
			  <th style='width:100px'>Kapasitas</th>
              <th style='width:100px'>Lantai</th>
			  <th style='width:250px'>Prodi</th>
