...
{	$Foto = AmbilOneField('mhsw', "MhswID='$MhswID' and KodeID", KodeID, 'FotoBro');
...
function Isinya($MhswID, $p) {
  ...
  $p->SetFont('Helvetica', '', 12);
  $p->Cell($kolom2, $t, $mhsw['ProgramID'].' - '.AmbilOneField('program', "ProgramID='$mhsw[ProgramID]' and KodeID", KodeID, 'Nama'), 0, 1);
  
  $p->SetFont('Helvetica', 'B', 12);
  $p->Cell($kolom1, $t, 'Program Studi :', 0, 0, 'R');
  $p->SetFont('Helvetica', '', 12);
  $p->Cell($kolom2, $t, $mhsw['ProdiID'].' - '.AmbilOneField('prodi', "ProdiID='$mhsw[ProdiID]' and KodeID", KodeID, 'Nama'), 0, 1);
  
  $p->SetFont('Helvetica', 'B', 12);
  $p->Cell($kolom1, $t, 'Dosen Pembimbing :', 0, 0, 'R');
  $p->SetFont('Helvetica', '', 12);
  $p->Cell($kolom2, $t, AmbilOneField('dosen', "Login='$mhsw[DosenID]' and KodeID", KodeID, 'Nama'), 0, 1);
  ...
  $p->SetFont('Helvetica', '', 9);
  $p->Cell($kolom2, $t, AmbilOneField('kelamin', 'Kelamin', $mhsw['Kelamin'], 'Nama'), 0, 0);
  $p->SetFont('Helvetica', 'B', 9);
  ...
  $p->SetFont('Helvetica', '', 9);
  $p->Cell($kolom2, $t, $mhsw['Agama'], 0, 0);
  $p->SetFont('Helvetica', 'B', 9);
  ...
  $p->SetFont('Helvetica', '', 9);
  $p->Cell($kolom2, $t, $mhsw['StatusSipil'], 0, 0);
  $p->SetFont('Helvetica', 'B', 9);
  ...
  $p->SetFont('Helvetica', '', 9);
  $AsalSekolah = AmbilOneField('asalsekolah', 'SekolahID', $mhsw['AsalSekolah'], 'Nama'); 
  $p->Cell($kolom2, $t, (empty($AsalSekolah))? $mhsw['AsalSekolah'] : $AsalSekolah, 0, 0);
  $p->SetFont('Helvetica', 'B', 9);
  $p->Cell($kolom1b, $t, 'Jurusan :', 0, 0, 'R');
  $p->SetFont('Helvetica', '', 9);
  $p->Cell($kolom2, $t, $mhsw['JurusanSekolah'], 0, 1);
  ...
  $p->SetFont('Helvetica', '', 9);
  $p->Cell($kolom2, $t, $mhsw['AgamaAyah'], 0, 0); 
  $p->SetFont('Helvetica', 'B', 9);
  $p->Cell($kolom1b, $t, 'AgamaIbu :', 0, 0, 'R');
  $p->SetFont('Helvetica', '', 9);
  $p->Cell($kolom2, $t, $mhsw['AgamaIbu'], 0, 1);
  ...
  $p->Cell($kolom2, $t, $mhsw['AgamaAyah'], 0, 0); 
  $p->SetFont('Helvetica', 'B', 9);
  $p->Cell($kolom1b, $t, 'Agama Ibu :', 0, 0, 'R');
  $p->SetFont('Helvetica', '', 9);
  $p->Cell($kolom2, $t, $mhsw['AgamaIbu'], 0, 1);
  ...
  $p->SetFont('Helvetica', '', 9);
  $p->Cell($kolom2, $t, $mhsw['PendidikanAyah'], 0, 0); 
  $p->SetFont('Helvetica', 'B', 9);
  $p->Cell($kolom1b, $t, 'Pendidikan Ibu :', 0, 0, 'R');
  $p->SetFont('Helvetica', '', 9);
  $p->Cell($kolom2, $t, $mhsw['PendidikanIbu'], 0, 1);
  
  $p->SetFont('Helvetica', 'B', 9);
  $p->Cell($kolom1b, $t, 'Pekerjaan Ayah :', 0, 0, 'R');
  $p->SetFont('Helvetica', '', 9);
  $p->Cell($kolom2, $t, $mhsw['PekerjaanAyah'], 0, 0); 
  $p->SetFont('Helvetica', 'B', 9);
  $p->Cell($kolom1b, $t, 'Pekerjaan Ibu :', 0, 0, 'R');
  $p->SetFont('Helvetica', '', 9);
  $p->Cell($kolom2, $t, $mhsw['PekerjaanIbu'], 0, 1);
