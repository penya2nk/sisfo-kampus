...
session_start();
  ...
  include_once "../fpdf.php";
	...
	$jdwl = AmbilFieldx("jadwal j
		...
		",
		"j.JadwalID", $JadwalID,
		"k.Nama as _NamaKelas, j.*, concat(d.Nama, ', ', d.Gelar) as DSN, d.NIDN,
...
*/
$Kolom = AmbilOneField('jadwal', "KodeID='".KodeID."' and JadwalID", $_REQUEST['JadwalID'], 'RencanaKehadiran');
$lbr = 280;
...
function BuatHeader($jdwl, $Kolom, $p) {
  $NamaTahun = AmbilOneField('tahun', "KodeID='".KodeID."' and TahunID='$jdwl[TahunID]' and ProdiID",
    $jdwl['ProdiID'], 'Nama');
  $t = 6; $lbr = 200;

  $arr = array();
  $arr[] = array('Mata Kuliah', ':', $jdwl['MKKode'] . ' - ' . $jdwl['Nama']);
  $arr[] = array('Kelas / Thn Akd', ':', $jdwl['_NamaKelas'] . ' - ( Ruang: ' . $jdwl['RuangID'] . ' ) '.
    ' / ' . $NamaTahun, 
