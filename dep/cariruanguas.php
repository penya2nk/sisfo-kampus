...
TitleApps("Cari Ruang UAS- $prd <sup>($ProdiID)</sup><br /><font size=-1><a href='#' onClick=\"toggleBox('$div', 0)\">(&times; Close &times;)</a></font>");
TampilkanDaftar();
...
function TampilkanDaftar() {
  ...
  while ($w = mysqli_fetch_array($r)) {
    ...
    echo <<<SCR
      ...
      <td class=ul1>
        <a href="javascript:$_SESSION[frm].UASRuangID.value='$w[RuangID]';$_SESSION[frm].UASKapasitas.value='$w[Kapasitas]';
							$_SESSION[frm].UASKolomUjian.value='$w[KolomUjian]'; $_SESSION[frm].UASBarisUjian.value='$w[BarisUjian]'; toggleBox('$_SESSION[div]', 0)">$w[Nama]</a>
      </td>
