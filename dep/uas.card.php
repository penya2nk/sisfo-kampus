...
<tr>
  ...
  <input class='btn btn-success btn-sm' type=button name='Cetak' value='Cetak Daftar Yang Tidak Bisa UAS' onClick="CetakDaftarTakBisaUjian()">
  <input class='btn btn-primary btn-sm' type=submit name='btnCetak' value='Cetak Kartu UAS' />
	  </td>
	  </tr>
  </form>
  </table>
