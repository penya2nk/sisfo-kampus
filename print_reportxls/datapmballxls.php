...
$namaFile = "PMB_".$_GET[tahun]."_.xls";
/**/
...
<tr>
<td colspan=9><b><u>Data PMB Tahun: $_GET[tahun]</u></b></td>
</tr>
...
$sqx = mysqli_query($koneksi, "SELECT * from t_gelombang order by PMBPeriodID asc");		
...
echo"<tr style='background-color:#E6E6E6'>
  ...
  <th width='50' align='left'>&nbsp;Registered?</th>
