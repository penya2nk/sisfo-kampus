...
<th width='600' align='center'>MATA KULIAHx</th>
...
while ($j = mysqli_fetch_array($dosen)){
		$totsks = mysqli_fetch_array(mysqli_query($koneksi, "SELECT sum(SKS) as TotSKS FROM jadwal_rekapsks where DosenID='$j[Login]' "));
$hd++;
echo"<tr style='background-color:#DFF4FF'>
<td colspan='6' height='20' ><b>&nbsp;  $hd.  $j[Nama],$j[Gelar] - $j[Handphone] - $j[TotSKS]</b></td>
</tr>";	
