...
$namaFile = "$mhs[Nama]_".$_GET[MhswID]."_TraskripNilaiSP.xls";
...
$sq = mysqli_query($koneksi, "SELECT * FROM vw_transkripsp WHERE MhswID='".strfilter($_GET[MhswID])."' AND JenisMK='$j[Nama]' ORDER BY MKKode,substr(MKKode,0,4) ASC");
