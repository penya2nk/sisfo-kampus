...
// *** Main ***
TitleApps("Ubah Password Aplikan");
...
function frmPwd($AplikanID) {
  ...
  $aplikan = AmbilFieldx('aplikan', "KodeID='".KodeID."' and AplikanID", $AplikanID,
...
function SimpanPwd($_MhswID) {
  ...
  if(AmbilOneField('aplikan', "AplikanID='$AplikanID' and KodeID", KodeID, 'PasswordBaru') == 'Y')
  {	  $s = "update aplikan 
  ...
  {
	  if(AmbilOneField('aplikan', "AplikanID='$AplikanID' and KodeID", KodeID, 'HintAnswer') == $HintAnswer)
	  {
		  $s = "update aplikan
			set Password=LEFT(PASSWORD('$PasswordBaru1'), 10), PasswordBaru='N' 
			where KodeID = '".KodeID."'
