...
$wid = $_REQUEST['WID'];
$gelombang = AmbilFieldx('pmbperiod', "KodeID='".KodeID."' and NA", 'N', "*");
...
$lbr1 = 0;
	...
	//$HasilRekomendasi = AmbilOneField('wawancara', "WawancaraID='$wid' and KodeID", KodeID, 'HasilWawancara');	
	$pmbformulir = AmbilFieldx('pmbformulir', "PMBFormulirID='$w[PMBFormulirID]' and KodeID", KodeID, "USM, Wawancara");
...
{	
global $koneksi;
$NomerSurat = AmbilOneField('pmb', "PMBID='$pmb[PMBID]' and KodeID", KodeID, 'NomerSurat');
...
$count=0;
	...
	{	$count++;
		$PMB = AmbilFieldx('pmb p left outer join prodi prd on p.ProdiID=prd.ProdiID
