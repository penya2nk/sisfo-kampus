...
function DftrGelombang() {
  ...
  $pagefmt = "<a href='?ndelox=$_SESSION[ndelox]&lungo=gelombang&sub=&_gelombangpage==PAGE='>=PAGE=</a>";
  $pageoff = "<b>=PAGE=</b>";
...
<div class='table-responsive'>
  ...
  $lst->detailfmt = "<tr>
    ...
    <td class=ul1 width=10>
      <a href='#' onClick=\"javascript:GelEdt(0, '=PMBPeriodID=', '$_SESSION[ndelox]')\"><i class='fa fa-edit'></i></a></td>
