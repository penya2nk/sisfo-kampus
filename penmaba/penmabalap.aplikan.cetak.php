...
//$FG1 = AmbilOneField("aplikan a left outer join pmbperiod p on a.PMBPeriodID=p.PMBPeriodID and a.KodeID=p.KodeID and p.Tahun='".$_SESSION[Tahun1]."'", 
...
//							"count(a.AplikanID)");
//$FG2 = AmbilOneField("aplikan a left outer join pmbperiod p on a.PMBPeriodID=p.PMBPeriodID and a.KodeID=p.KodeID and p.Tahun='".$_SESSION[Tahun2]."'", 
...
//							"count(a.AplikanID)");
//$NFG1 = AmbilOneField("aplikan a left outer join pmbperiod p on a.PMBPeriodID=p.PMBPeriodID and a.KodeID=p.KodeID and p.Tahun='".$_SESSION[Tahun1]."'", 
//							"INSTR(a.SumberInformasi, $w[InfoID])>0 and a.TahunLulus < '$Tahun1a' and a.KodeID", KodeID, 
//							"count(a.AplikanID)");
//$NFG2 = AmbilOneField("aplikan a left outer join pmbperiod p on a.PMBPeriodID=p.PMBPeriodID and a.KodeID=p.KodeID and p.Tahun='".$_SESSION[Tahun2]."'", 
