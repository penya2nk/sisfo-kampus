...
<div class='table-responsive'>
  ...
  <form name='frmBayar' action='../$_SESSION[ndelox].bayar.php' method=POST onSubmit=\"return CheckForm(this)\">
...
function TampilkanDetailBiaya($MhswID, $mhsw, $khs, $md) {
  ...
  <div class='table-responsive'>
  <table class=box cellspacing=1 width=100%>";
  echo "<tr style='background:purple;color:white'><th class=ttl colspan=7>Detail Biaya</th></tr>";
...
<SCRIPT>
  function ttutup() {
    opener.location='../index.php?ndelox=$_SESSION[ndelox]&lungo=MahasiswaDetail&MhswID=$MhswID';
    self.close();
    return false;
  }
  ttutup();
